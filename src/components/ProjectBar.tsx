...
const ProjectBar: React.FC = () => {
    ...
    const projects = [
        ...
        {projectName: "project", projectThumbnail: "/vite.svg", projectDetails: "Vite template", projectTags: ["rEact", "vite"]},
        {projectName: "project", projectThumbnail: "/vite.svg", projectDetails: "Vite template", projectTags: ["express", "react", "vite"]},
    ]
